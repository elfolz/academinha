"use strict";(globalThis["webpackChunkAcademinha"]=globalThis["webpackChunkAcademinha"]||[]).push([[375],{7790:(e,t,r)=>{r.d(t,{BH:()=>l,L:()=>a,LL:()=>A,Lj:()=>F,UG:()=>p,X3:()=>Z,ZB:()=>h,ZR:()=>S,b$:()=>m,eu:()=>_,hl:()=>y,jU:()=>b,m9:()=>L,ne:()=>$,pd:()=>I,r3:()=>C,ru:()=>g,tV:()=>c,uI:()=>f,vZ:()=>j,w1:()=>v,xO:()=>T,xb:()=>x,z$:()=>d,zI:()=>E,zd:()=>k});r(1703),r(2801);
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h(e,t){if(!(t instanceof Object))return t;switch(t.constructor){case Date:const r=t;return new Date(r.getTime());case Object:void 0===e&&(e={});break;case Array:e=[];break;default:return t}for(const r in t)t.hasOwnProperty(r)&&u(r)&&(e[r]=h(e[r],t[r]));return e}function u(e){return"__proto__"!==e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const O="FirebaseError";class S extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=O,Object.setPrototypeOf(this,S.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,A.prototype.create)}}class A{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},o=`${this.service}/${e}`,n=this.errors[e],s=n?w(n,r):"Error",i=`${this.serviceName}: ${s} (${o}).`,a=new S(o,i,r);return a}}function w(e,t){return e.replace(D,((e,r)=>{const o=t[r];return null!=o?String(o):`<${r}?>`}))}const D=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T(e){const t=[];for(const[r,o]of Object.entries(e))Array.isArray(o)?o.forEach((e=>{t.push(encodeURIComponent(r)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(r)+"="+encodeURIComponent(o));return t.length?"&"+t.join("&"):""}function k(e){const t={},r=e.replace(/^\?/,"").split("&");return r.forEach((e=>{if(e){const[r,o]=e.split("=");t[decodeURIComponent(r)]=decodeURIComponent(o)}})),t}function I(e){const t=e.indexOf("?");if(!t)return"";const r=e.indexOf("#",t);return e.substring(t,r>0?r:void 0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $(e,t){const r=new M(e,t);return r.subscribe.bind(r)}class M{constructor(e,t){this.observers=[],this.unsubscribes=[],this.observerCount=0,this.task=Promise.resolve(),this.finalized=!1,this.onNoObservers=t,this.task.then((()=>{e(this)})).catch((e=>{this.error(e)}))}next(e){this.forEachObserver((t=>{t.next(e)}))}error(e){this.forEachObserver((t=>{t.error(e)})),this.close(e)}complete(){this.forEachObserver((e=>{e.complete()})),this.close()}subscribe(e,t,r){let o;if(void 0===e&&void 0===t&&void 0===r)throw new Error("Missing Observer.");o=N(e,["next","error","complete"])?e:{next:e,error:t,complete:r},void 0===o.next&&(o.next=P),void 0===o.error&&(o.error=P),void 0===o.complete&&(o.complete=P);const n=this.unsubscribeOne.bind(this,this.observers.length);return this.finalized&&this.task.then((()=>{try{this.finalError?o.error(this.finalError):o.complete()}catch(e){}})),this.observers.push(o),n}unsubscribeOne(e){void 0!==this.observers&&void 0!==this.observers[e]&&(delete this.observers[e],this.observerCount-=1,0===this.observerCount&&void 0!==this.onNoObservers&&this.onNoObservers(this))}forEachObserver(e){if(!this.finalized)for(let t=0;t<this.observers.length;t++)this.sendOne(t,e)}sendOne(e,t){this.task.then((()=>{if(void 0!==this.observers&&void 0!==this.observers[e])try{t(this.observers[e])}catch(r){"undefined"!==typeof console&&console.error&&console.error(r)}}))}close(e){this.finalized||(this.finalized=!0,void 0!==e&&(this.finalError=e),this.task.then((()=>{this.observers=void 0,this.onNoObservers=void 0})))}}function N(e,t){if("object"!==typeof e||null===e)return!1;for(const r of t)if(r in e&&"function"===typeof e[r])return!0;return!1}function P(){}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function V(e,t){return new Promise(((r,o)=>{e.onsuccess=e=>{r(e.target.result)},e.onerror=e=>{var r;o(`${t}: ${null===(r=e.target.error)||void 0===r?void 0:r.message}`)}}))}class R{constructor(e){this._db=e,this.objectStoreNames=this._db.objectStoreNames}transaction(e,t="readonly"){return new W(this._db.transaction.call(this._db,e,t))}createObjectStore(e,t){return new U(this._db.createObjectStore(e,t))}close(){this._db.close()}}class W{constructor(e){this._transaction=e,this.complete=new Promise(((e,t)=>{this._transaction.oncomplete=function(){e()},this._transaction.onerror=()=>{t(this._transaction.error)},this._transaction.onabort=()=>{t(this._transaction.error)}}))}objectStore(e){return new U(this._transaction.objectStore(e))}}class U{constructor(e){this._store=e}index(e){return new z(this._store.index(e))}createIndex(e,t,r){return new z(this._store.createIndex(e,t,r))}get(e){const t=this._store.get(e);return V(t,"Error reading from IndexedDB")}put(e,t){const r=this._store.put(e,t);return V(r,"Error writing to IndexedDB")}delete(e){const t=this._store.delete(e);return V(t,"Error deleting from IndexedDB")}clear(){const e=this._store.clear();return V(e,"Error clearing IndexedDB object store")}}class z{constructor(e){this._index=e}get(e){const t=this._index.get(e);return V(t,"Error reading from IndexedDB")}}function Z(e,t,r){return new Promise(((o,n)=>{try{const s=indexedDB.open(e,t);s.onsuccess=e=>{o(new R(e.target.result))},s.onerror=e=>{var t;n(`Error opening indexedDB: ${null===(t=e.target.error)||void 0===t?void 0:t.message}`)},s.onupgradeneeded=e=>{r(new R(s.result),e.oldVersion,e.newVersion,new W(s.transaction))}}catch(s){n(`Error opening indexedDB: ${s.message}`)}}))}async function F(e){return new Promise(((t,r)=>{try{const o=indexedDB.deleteDatabase(e);o.onsuccess=()=>{t()},o.onerror=t=>{var o;r(`Error deleting indexedDB database "${e}": ${null===(o=t.target.error)||void 0===o?void 0:o.message}`)}}catch(o){r(`Error deleting indexedDB database "${e}": ${o.message}`)}}))}},4270:(e,t,r)=>{r.d(t,{_T:()=>o});r(1703);function o(e,t){var r={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(r[o]=e[o]);if(null!=e&&"function"===typeof Object.getOwnPropertySymbols){var n=0;for(o=Object.getOwnPropertySymbols(e);n<o.length;n++)t.indexOf(o[n])<0&&Object.prototype.propertyIsEnumerable.call(e,o[n])&&(r[o[n]]=e[o[n]])}return r}Object.create;Object.create},5510:(e,t,r)=>{r.r(t),r.d(t,{default:()=>g});var o=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("main",[e.loading?[r("figure",[r("img",{attrs:{src:"/img/social/"+e.loading+"-color.svg",alt:"Rede social"}}),r("v-skeleton-loader",{attrs:{type:"list-item-avatar-three-line"}})],1)]:[e._m(0),r("footer",[e._v("Entre com uma de suas redes sociais")]),e._l(e.providers,(function(t,o){return r("v-btn",{key:o,class:t,attrs:{fab:""},on:{click:function(r){return e.requestLogin(t)}}},[r("img",{attrs:{src:"/img/social/"+t+".svg",alt:t}})])}))]],2)},n=[function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("figure",[r("img",{attrs:{src:"/img/icons/android-chrome-192x192.png",alt:"Academinha"}}),r("figcaption",[e._v("Academinha")])])}],s=r(5546);r(2833),r(7277);const i=s.Z.initializeApp({apiKey:"AIzaSyAqMD2es1n6hjUbUuEuHLFaWzDPddAFq5c",authDomain:"academinha-beb1f.firebaseapp.com",databaseURL:"https://academinha-beb1f-default-rtdb.firebaseio.com",projectId:"academinha-beb1f",storageBucket:"academinha-beb1f.appspot.com",messagingSenderId:"543263128562",appId:"1:543263128562:web:ecd9f57c8a49a2a59e496b"});var a=r(5843);const c={data(){return{loading:null,providers:["google","facebook","microsoft","twitter"]}},mounted(){this.$route.params.provider&&this.executeLogin()},methods:{requestLogin(e){switch(this.$router.push({params:{provider:e}}),e){case"google":e=new a.hJ;break;case"facebook":e=new a._O;break;case"twitter":e=new a.c4;break;case"microsoft":e=new a.O4("microsoft.com");break}i.auth().signInWithRedirect(e)},executeLogin(){this.loading=this.$route.params.provider,i.auth().setPersistence("none").finally((()=>i.auth().getRedirectResult().then((e=>{if(!e.credential)return this.$router.push("/login"),this.$store.dispatch("openAlert",{text:"Erro ao fazer o login. Tente novamente",color:"error"});let t={name:e.user.providerData[0].displayName,socialId:e.user.providerData[0].uid,provider:e.credential.providerId.replace(".com",""),email:e.user.providerData[0].email};return this.axios.post("/auth/login",t).then((e=>{this.$auth.authenticate(e.data)}))})).catch((e=>{console.log(e),this.$store.dispatch("openAlert",{text:"Erro ao fazer o login. Tente novamente",color:"error"})})))).finally((()=>{this.loading=null}))}}},h=c;var u=r(1001),l=r(3453),d=r.n(l),f=r(7080),p=r(9559),b=(0,u.Z)(h,o,n,!1,null,"8e1e70b4",null);const g=b.exports;d()(b,{VBtn:f.Z,VSkeletonLoader:p.Z})}}]);